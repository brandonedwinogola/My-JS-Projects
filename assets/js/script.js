...
fetch('./assets/js/projects.json')
    ...
    <div class="box">
        ...
        <div class="btns">
            ...
            <a href="https://github.com/brandonedwinogola/My-JS-Projects/tree/main/projects/"${proj.meta}" class="btn" target="_blank">Code <i class="fas fa-code"></i></a>
        </div>
        </div>
    </div>`;
        });
...
var _CONTENT = [
    ...
    "Build any JavaScript Project☺️☺️☺️...",
